...
run_once({ "urxvtd", "unclutter -root", "light-locker &" }) -- comma-separated entries
...
globalkeys = mytable.join(
    ...
    awful.key({ altkey }, "p", function() os.execute("scrot -s - | xclip -selection clipboard -i -t image/png") end,
